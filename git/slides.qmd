...
![](fig/git.svg){fig-alt="Git workflow" fig-align="center" width="100%"}
...
![New GitHub repo 1](fig/new-github-repo-step1.png){width="90%"}

![New GitHub repo 2](fig/new-github-repo-step2.png){width="90%"}
