...
::: {.callout-note}
The content of this lab is based on UofU's PHS 7045 (Advanced Programming with R and HPC) ([link](https://github.com/UofUEpiBio/PHS7045-advanced-programming){target="_blank"}).
:::
...
We will be working with the repository <https://github.com/EpiForeSITE/whoamit>
...
![](https://user-images.githubusercontent.com/893619/132388465-849ef04d-ad4f-4365-a646-27e88cb9d828.png){width=90%}
